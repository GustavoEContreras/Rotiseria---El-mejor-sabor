...
urlpatterns = [
    ...
    path('EliminarPlato/<int:plato_id>/<int:menu_id>', views.QuitarPlato, name="quitarPlato"),
    path('AgregarPlato/<int:menu_id>', views.AgregarPlato, name="agregarPlato"),
    path('CambiarPrecioPlato/<int:plato_id>/<int:menu_id>', views.CambiarPrecioPlato, name="cambiarPrecioPlato"),
